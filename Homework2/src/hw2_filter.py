...
def extending(img, filterHeight, filterWidth):
    # extending image
    extendImg = np.zeros((img.shape[0]+(filterHeight-1)*2, img.shape[1]+(filterWidth-1)*2), dtype=int)
    ...
    # debug size
    # print ("Image's size : ", img.shape)
    # print ("filter's size : ", filter.shape)
    # print ("extendImg's size : ", extendImg.shape)
